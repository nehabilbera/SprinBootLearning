...
/*
method-1 ----- ApiResponse is a class (POJO class)
...
/*
method-2 ----- ApiResponse is a record which don't have getter and setter
    public record ApiResponse<T> (T data, String message, Date timeStamp, String status){}
*/


//method-3 ----- ApiResponse is a record having static factory method having success and error
public record ApiResponse<T> (T data, String message, Date timeStamp, String status){
